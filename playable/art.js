...
function draw(i,t=starts[i]+durations[i]*.5){f=i;g.imageSmoothingEnabled=false;const [x,y,w,h,ax,ay]=crops[i];g.drawImage(sprite,x,y,w,h,340+(x-ax)*.88,360+(y-ay)*.88,w*.88,h*.88);trails(t);}
